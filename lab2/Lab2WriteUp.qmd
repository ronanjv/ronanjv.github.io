...
**Solution**
Here I am installing the esquisse packing to get started.
```{r}
#| eval: false
#| code-fold: false
...
**Solution**
Here I am loading the esquisse package to be used later on.
...
**Solution**
Testing the help function, here I am using help() to get more information on using the esquisse package.
```{r}
#| eval: false
#| code-fold: false
help("esquisse")
...
**Solution**
There is no demo found for the equisse package, but a vignette is available.
```{r}
#| eval: false
#| code-fold: false
